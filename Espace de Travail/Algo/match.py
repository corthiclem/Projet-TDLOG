...
################################################################################
# Voici à quoi ressemblent les listes de préférence
            ...
            for guy in shelikesbetter:
                ...
                if guy not in engaged[she]:
                    ...
                    # si 'guy' est sans partenaire
                        ...
                        # alors le match n'est pas stable car 'she' prefererait être en couple avec 'guy' plutôt que 'he'
                        return False
